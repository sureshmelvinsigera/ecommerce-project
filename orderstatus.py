...
class OrderStatus:
    """
    This class provides utility methods for order status related tasks.
    """
    ...
    def status(account_number):
        """
        This method allows the site admin or 3rd party seller to update the shipping status.
        Such that, Order is awaiting picking, Order is shipped, Order is delayed or Order is delivered by using the
        six digits unique order number which was generated by the order class.
        :param account_number:
        :return:
        """
        user_record = OrderStatus.__ecommerce_data.get(account_number)
        # check if there is any orders for current logged in seller or site owner
